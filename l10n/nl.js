OC.L10N.register(
    ...
    "No compatible server found at {remote}" : "Geen compatibele server gevonden op {remote}",
    ...
    "<strong>Error!</strong> Could not generate a preview of this file.<br>Please go to the next slide while we remove this image from the slideshow" : "<strong>Fout!</strong> Het is niet mogelijk om een voorbeeld van dit bestand te genereren.<br>Gaat u alstublieft naar de volgende slide, terwijl we deze afbeelding uit de slideshow verwijderen",
    "Next" : "Volgende",
    "Play" : "Afspelen",
    "Pause" : "Pauze",
    "Previous" : "Vorige",
