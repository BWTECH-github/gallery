OC.L10N.register(
    ...
    "No compatible server found at {remote}" : "ไม่พบเซิร์ฟเวอร์ที่รองรับจาก {remote}",
    "Invalid server url" : "URL ของเซิร์ฟเวอร์ไม่ถูกต้อง",
    ...
    "Upload pictures in the files app to display them here" : "อัปโหลดรูปภาพในไฟล์แอพฯเพื่อแสดงพวกเขาที่นี่",
    "Upload new files via drag and drop or by using the [+] button above" : "อัปโหลดไฟล์ใหม่ผ่านการลากและวางหรือโดยการใช้ปุ่ม [+] ดังกล่าวข้างต้น",
    ...
    "Share" : "แชร์",
    "Share with people on other servers using the syntax username@example.com/owncloud" : "แชร์กับคนใน Servern อื่นๆ ที่ใช้ไวยากรณ์ username@example.com/owncloud ",
    ...
    "Password" : "รหัสผ่าน",
    "Choose a password for the public link" : "เลือกรหัสผ่านสำหรับลิงก์สาธารณะ",
    ...
    "For more information, please contact your friendly owncloud.online administrator." : "สำหรับข้อมูลเพิ่มเติมโปรดติดต่อผู้ดูแลระบบ owncloud.online ของคุณ",
    ...
    "Sorry, this link doesn't seem to work anymore." : "ขออภัย ลิงก์นี้ดูเหมือนจะมีปัญหา",
    "the item was removed" : "รายการที่ถูกลบออก",
    "the link has expired" : "ลิงก์หมดอายุ",
    "sharing is disabled" : "การแชร์ถูกปิดใช้งาน",
    "For more information, please ask the person who has sent you this link." : "สำหรับข้อมูลเพิ่มเติม โปรดถามคนที่ส่งลิงก์นี้ให้คุณ",
    "Add to your owncloud.online" : "เพิ่มลงใน owncloud.online ของคุณ",
