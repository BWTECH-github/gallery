OC.L10N.register(
    ...
    {
    "Gallery" : "Galariá",
    "There was a problem reading files from this album" : "I a agut un problèma al moment e la lectura dels fichièrs d'aqueste album",
    ...
    "No compatible server found at {remote}" : "Cap de servidor compatible pas trobat sus {remote}",
    "Invalid server url" : "URL del servidor invalid",
    ...
    "Upload new files via drag and drop or by using the [+] button above" : "Mandatz de fichièrs novèls en utilizant lo lisar-depausar o lo boton [+] çaisús",
    "Configuration error" : "Error de configuracion",
    "New" : "Novèl",
    "Hide Album" : "Amagar l'album",
    "Could not hide album" : "Impossible d'amagar l'album",
    "Error loading slideshow template" : "Error al moment del telecargament del modèl de diaporama ",
    "<strong>Error!</strong> Could not generate a preview of this file.<br>Please go to the next slide while we remove this image from the slideshow" : "<strong>Error !</strong> Impossible de generar un apercebut d'aqueste fichièr.<br>Mercé d'anar a la diapositiva seguenta pendent que suprimissèm aqueste imatge d'aqueste diaporama",
    "Next" : "Seguent",
    "Play" : "Aviar",
    "Pause" : "Pausa",
    "Previous" : "Precedent",
    ...
    "Error while retrieving shares" : "Error al moment de la recuperacion dels partiments",
