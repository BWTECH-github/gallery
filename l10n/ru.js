OC.L10N.register(
    ...
    "No compatible server found at {remote}" : "Не обнаружен совместимый сервер по адресу {remote}",
    ...
    "<strong>Error!</strong> Could not generate a preview of this file.<br>Please go to the next slide while we remove this image from the slideshow" : "<strong>Ошибка!</strong> Не удалось создать предпросмотр файлы. <br>Пожалуйста переходите к следующему слайду, пока мы удалим это изображение из слайд-шоу",
    "Next" : "Следующий",
    "Play" : "Проиграть",
    "Pause" : "Пауза",
    "Previous" : "Предыдущий",
