OC.L10N.register(
    ...
    "No compatible server found at {remote}" : "{remote}에서 호환 가능한 서버를 찾을 수 없음",
    ...
    "Album cannot be shown" : "앨범을 표시할 수 없음",
    "No media files found" : "미디어 파일을 찾을 수 없음",
    "Upload pictures in the files app to display them here" : "파일 앱에서 사진을 올리면 여기에 표시됩니다",
    "Upload new files via drag and drop or by using the [+] button above" : "드래그 앤 드롭 및 위에 있는 [+] 단추로 새 파일 업로드",
    "Configuration error" : "설정 오류",
    "New" : "새로 만들기",
    "Hide Album" : "앨범 숨기기",
    "Could not hide album" : "앨범을 숨길 수 없음",
    "Error loading slideshow template" : "슬라이드 쇼 템플릿을 불러오는 중 오류 발생",
    "<strong>Error!</strong> Could not generate a preview of this file.<br>Please go to the next slide while we remove this image from the slideshow" : "<strong>오류!</strong> 이 파일을 미리 볼 수 없습니다.<br>이 사진을 슬라이드 쇼에서 삭제하는 동안 다음 슬라이드로 이동하십시오",
    "Next" : "다음",
    "Play" : "재생",
    "Pause" : "일시 정지",
    "Previous" : "이전",
