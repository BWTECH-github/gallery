OC.L10N.register(
    ...
    "No compatible server found at {remote}" : "Nie znaleziono prawidłowego serwera na {remote}",
    "Invalid server url" : "Niepoprawny adres URL serwera",
    "Gallery view" : "Widok galerii",
    "Could not load the description" : "Nie można wczytać opisu",
    "Could not load the description: " : "Nie można załadować opisu:",
    "Copyright" : "Prawa autorskie",
    "Could not load the copyright notice: " : "Nie można załadować informacji o prawach autorskich:",
    "Copyright notice" : "Informacja o prawach autorskich",
    "Link to copyright document" : "Odnośnik do dokumentu o prawach autorskich",
    "This application may not work properly on your browser." : "Ta aplikacja może nie działać prawidłowo na twojej przeglądarce.",
    "For an improved experience, please install one of the following alternatives" : "Proszę zainstalować jedną z następujących alternatyw, aby uzyskać lepsze doświadczenie.",
    "Your browser is not supported!" : "Twoja przeglądarka jest niewspierana!",
    ...
    "Upload pictures in the files app to display them here" : "Aby wyświetlić zdjęcia w plikach aplikacji, należy je tam wgrać",
    "Upload new files via drag and drop or by using the [+] button above" : "Wgranie plików odbywa się poprzez funkcję przeciągnij i upuść lub przy użyciu przycisku [+] poniżej",
    "Configuration error" : "Błąd konfiguracji",
    "New" : "Nowy",
    "Hide Album" : "Ukryj album",
    "Could not hide album" : "Nie można ukryć albumu",
    "Error loading slideshow template" : "Błąd podczas ładowania szablonu pokazu slajdów",
    "<strong>Error!</strong> Could not generate a preview of this file.<br>Please go to the next slide while we remove this image from the slideshow" : "<strong>Wystąpił błąd!</strong>Nie można wygenerować podglądu danego pliku. <br>Obecny plik zostanie usunięty z całego pokazu, po przejściu do następnego slajdu",
    "Next" : "Następny",
    "Play" : "Odtwarzaj",
    "Pause" : "Wstrzymaj",
    "Previous" : "Poprzedni",
    ...
    "Error while retrieving shares" : "Wystąpił błąd podczas próby pobrania udziałów",
    ...
    "the wrong file ID was provided" : "podano nieprawidłowy identyfikator pliku",
    ...
    "a required component is missing or was disconnected" : "Brakuje wymaganego komponentu lub jest on wyłączony",
    "the filesystem is not readable" : "System plików nie pozwala na odczyt",
