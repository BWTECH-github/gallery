OC.L10N.register(
    ...
    "No compatible server found at {remote}" : "Nem található kompatibilis szerver ezen a címen {remote}",
    "Invalid server url" : "Érvénytelen szerver url cím",
    ...
    "For an improved experience, please install one of the following alternatives" : "A jobb teljesítmény érdekében, kérjük telepítsen egy alternatívát a következők közül",
    "Your browser is not supported!" : "A böngészője nem támogatott!",
    "please install one of the following alternatives" : "kérjük telepítsen egy alternatívát a következők közül",
    ...
    "Could not hide album" : "Nem lehet az albumot elrejteni",
    "Error loading slideshow template" : "Hiba történt a diasor sablonjának betöltésekor",
    "<strong>Error!</strong> Could not generate a preview of this file.<br>Please go to the next slide while we remove this image from the slideshow" : "<strong>Hiba!</strong>Nem készíthető előnézet a fájlról.<br>Kérjük, menjen a következő diára, amíg eltávolítjuk ezt a képet a diavetítésből.",
    "Next" : "Következő",
    "Play" : "Lejátszás",
    "Pause" : "Szünet",
    "Previous" : "Előző",
    ...
    "Share" : "Megosztás",
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Megosztás más owncloud.online szerverekkel, a következő formátum használatával felhasznalo@példa.com/owncloud",
    ...
    "For more information, please contact your friendly owncloud.online administrator." : "Bővebb információért, kérjük keresse fel a barátságos owncloud.online rendszergazdáját.",
    ...
    "Add to your owncloud.online" : "Adjuk hozzá a saját owncloud.onlineunkhoz",
