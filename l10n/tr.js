OC.L10N.register(
    ...
    {
    "Gallery" : "Galeri",
    "There was a problem reading files from this album" : "Bu albümden dosyalar okunurken bir hata oluştu",
    ...
    "No compatible server found at {remote}" : "{remote} adresinde uyumlu bir sunucu bulunamadı",
    ...
    "Album cannot be shown" : "Albüm gösterilemiyor",
    "No media files found" : "Hiçbir ortam dosyası bulunamadı",
    ...
    "Upload new files via drag and drop or by using the [+] button above" : "Yeni dosyaları sürükle ve bırak ile ya da yukarıdaki [+] düğmesini kullanarak yükleyin",
    ...
    "Error while retrieving shares" : "Paylaşımlar alınırken hata",
