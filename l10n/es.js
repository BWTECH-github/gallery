OC.L10N.register(
    ...
    "Could not move \"{file}\", target exists" : "\"{file}\" no se pudo mover, el destino ya existe.",
    "Could not move \"{file}\"" : "No se pudo mover \"{file}\"",
    "No compatible server found at {remote}" : "No se ha encontrado servidor compatible en {remote}",
    "Invalid server url" : "URL de servidor no válida.",
    ...
    "No media files found" : "Ningún fichero multimedia encontrado.",
    "Upload pictures in the files app to display them here" : "Suba fotos en la app de archivos para mostrarlos aquí",
    "Upload new files via drag and drop or by using the [+] button above" : "Sube nuevos ficheros mediante arrastrar y soltar  o usando el botón [+] encima.",
    ...
    "Share" : "Compartir",
    "Share with people on other servers using the syntax username@example.com/owncloud" : "Comparta con personas en otros Servern utilizando la sintáxis username@example.com/owncloud",
    ...
    "For more information, please contact your friendly owncloud.online administrator." : "Para obtener más información, póngase en contacto con el administrador de owncloud.online.",
    ...
    "Add to your owncloud.online" : "Agregue su propio owncloud.online",
